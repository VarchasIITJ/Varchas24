...
return (
  <div className="bg-black h-fit w-screen flex flex-col">
    ...
    <div className="bg-yellow-400 h-[35vh] md:h-[80vh] sm:h-[80vh] m-1 flex flex-col items-center justify-evenly rounded-2xl">
      <div className="text-4xl sm:text-5xl md:text-5xl font-bold mt-8 sm:mt-12 mb-6 sm:mb-10 text-center">
        <span className="font-robm bg-black text-yellow-400 p-2 sm:p-3 md:p-4 rounded-xl inline-block">
          Varchas Begins In
        </span>
      </div >
