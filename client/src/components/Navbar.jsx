    ...
    >
      ...
      >
        ...
        <div className="flex w-full justify-evenly  md:text-xl">
          ...
          <li
            className='p-1 mt-2 hover:text-[#ffeb3b] navbar relative text-lg '
            ref={dropdownRef}
          >
            <motion.button
              whileHover={{ scale: 1.03 }}
            ...
            {teamDropdown && (
              <ul className='bg-gray-800 rounded-xl text-white absolute left-0 mt-2 w-48 shadow-lg ring-1 ring-black ring-opacity-5'>
                <li className='px-4 py-2 text-sm hover:bg-black hover:text-white'>
                  <NavLink to='/create' onClick={() => setTeamDropdown(false)}>
                    Create Team
                  </NavLink>
                </li>
                <li className='px-4 py-2 text-sm hover:bg-black hover:text-white hover:rounded-b-xl'>
                  <NavLink to='/join' onClick={() => setTeamDropdown(false)}>
                    Join Team
                  </NavLink>
                </li>
              </ul>
